	...
	menu = {
		...
		["Edicoes Especiais"] = {
			...
			buttons = {
				...
				{name = "Onix", costs = 50000, description = {}, model = "stratum"},
				{name = "Fiat Toro", costs = 45000, description = {}, model = "rocoto"},
				{name = "Hyundai HB 20S", costs = 80000, description = {}, model = "surge"},
				{name = "Corolla", costs = 80000, description = {}, model = "oracle"},
				{name = "Hailux", costs = 120000, description = {}, model = "bison2"},
				{name = "Amarok", costs = 200000, description = {}, model = "dubsta"},
				{name = "Voyage", costs = 40000, description = {}, model = "asea2"},
				{name = "Pajero", costs = 33000, description = {}, model = "pajero4"},
				{name = "Santa Fé", costs = 35000, description = {}, model = "santafe"},
				{name = "Jeep", costs = 50000, description = {}, model = "srt8"},
				...
				{name = "Audi R8", costs = 400000, description = {}, model = "r8ppi"},
		...
		["Motos"] = {
			...
			buttons = {
				...
				{name = "Especial: Honda Biz", costs = 6000, description = {}, model = "manchez"},
				{name = "Especial: Honda Cb 300", costs = 10000, description = {}, model = "bati2"},
				{name = "Especial: Yamaha XJ6", costs = 30000, description = {}, model = "bati"},
				{name = "Especial: Agusta", costs = 60000, description = {}, model = "f4rr"},
				{name = "Especial: Hornet 600F", costs = 80000, description = {}, model = "ruffian"},
				{name = "Especial: Yamaha XJ6", costs = 90000, description = {}, model = "bati"},
