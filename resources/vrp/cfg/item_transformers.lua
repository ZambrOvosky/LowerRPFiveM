...
cfg.item_transformers = {
  ...
  -- PROCESSADOR DE METANFETAMINA
  {
    ...
    units_per_minute=400, -- unidades que o transformador ganha de volta por minuto
  ...
  -- Lavagem de dinheiro
 {
      ...
      max_units=1000,
      units_per_minute=1000,
      x=-835.19219970703,y=657.77136230469,z=133.51597595215, -- coordenas mudas aqui
      radius=2.5, height=1.5, -- area
      recipes = {
...
-- Carro Forte
  {
   ...
   -- TROCAR DINHEIRO BANCO
  {
    name="Dinheiro do Banco", -- menu name
    permissions = {"trade.money"}, -- you can add permissions
    r=0,g=200,b=0, -- cor do menu
    max_units=200, -- unidades maximas do item
    units_per_minute=20, -- unidades que o transformador ganha de volta por minuto
    x=809.24554443359,y=-288.68957519531,z=66.460075378418, -- pos -119.17678833008,-1486.1040039063,36.98205947876
    radius=2.5, height=1.5, -- area
    recipes = { -- items do menu
      ["Trocar Dinheiro do Banco"] = { -- action name
        description="", -- action description
        in_money=0, -- money taken per unit
        out_money=0, -- money earned per unit
        reagents={  -- items taken per unit
  ...
  -- CAÇADOR DE ANIMAIS
   {
    name="Coletar Carne", -- menu name
    permissions = {"mission.collect.carne"}, -- you can add permissions
    r=0,g=125,b=255, -- color
    max_units=10000,
    units_per_minute=10000,
    x=-752.09655761719,y=5677.537109375,z=23.322275161743,
    radius=3, height=1.5, -- area
    recipes = {
      ["Reunir Carne"] = { -- action name
        description="Coletando Carne", -- action description
        in_money=0, -- money taken per unit
        out_money=0, -- money earned per unit
        reagents={}, -- items taken per unit
        products={ -- items given per unit
